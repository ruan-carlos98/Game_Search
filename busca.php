...
$categoria = $_POST["categoria"];
  ...
  if ($categoria == "0"){
        ...
        $result_jogo = "SELECT
                    ...
                    t.fk_id_genero
                    FROM 
                    jogo j LEFT JOIN tipos t ON j.id_jogo = t.fk_id_jogo 
                    WHERE nome_jogo LIKE '%$pesquisa%'  
                    and t.fk_id_genero = $categoria";
        $resultado_jogo = mysqli_query($conn, $result_jogo);
           ...
           echo     '<div class="card-header bg-light">';
            echo        '<h5>'.$nome.'</h5>';
             ...
             echo   '<div class="card-footer bg-light">';
               echo     '<a class="d-block" href="jogo.php?name='.$nome.'">';
                 echo       '<button class="btn btn-danger">Página do Jogo</button>';
               echo     '</a>';
             echo   '</div>';
          echo  '</div>';
     echo   '</div>;';
