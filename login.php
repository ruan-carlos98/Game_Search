...
<div class="login">
    ...
    <a class="text-secondary" href="#" data-bs-toggle="modal" data-bs-target="#exampleModal">
    <p class="text-light text-center"><small>Esqueci minha senha</small></p>
    </a>
</div>
