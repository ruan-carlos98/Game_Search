...
<head>
    ...
    while($rows_jogo = mysqli_fetch_array($resultado_jogo)){
        ...
        $nota = $rows_jogo["nota_metacritic"];
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="painel.php" tabindex="-1">Meu Perfil</a>
                </li>
            </ul>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="embed-responsive embed-responsive-16by9">
                            <img class="ratio ratio-16x9 " src="<?php echo $foto ?>" width="560" height="auto" >
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="row justify-content-center">
                            <ul class="list-group list-group-horizontal">
                                <li>
                                    <a class="list-group-item" href = <?php echo $link_steam ?>>
                                        <img src="imagens/steam.png" width="50" height="50">
                                    </a>
                                    <small class="text-muted"><?php echo $steam ?>
                                    </small>
                                </li>
                                <li>
                                    <a class="list-group-item" href=<?php echo $link_epic ?>><img src="imagens/epic-games.png" width="50" height="50">
                                    </a>
                                    <small class="text-muted"><?php echo $epic ?></small>
                                </li>
                                <li>
                                    <a class="list-group-item" href=<?php echo $link_gog ?>><img src="imagens/gog.png" width="50" height="50">
                                    </a>
                                    <small class="text-muted"><?php echo $gog ?></small>
                                </li>
                                <li>
                                    <a class="list-group-item" href=<?php echo $link_xbox ?>><img src="imagens/game-pass.jpg" width="50" height="50">
                                    </a>
                                    <small class="text-muted"><?php echo $xbox ?></small>
                                </li>
                                <li>
                                    <a class="list-group-item" href="<?php echo $link_uplay ?>"><img src="imagens/uplay.png" width="50" height="50">
                                    </a>
                                    <small class="text-muted">
                                        <?php echo $uplay ?></small>
                                </li>
                                <li>
                                    <a class="list-group-item" href=<?php echo $link_origin ?>
                                    ><img src="imagens/origin.png" width="50" height="50">
                                    </a>
                                    <small class="text-muted"><?php echo $origin ?></small>
                                </li>
                            </ul>
                        </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="ratio ratio-16x9">
                                <iframe class="embed-responsive-item " src="<?php echo $trailer ?>" width="560" height="315" ></iframe>
                            </div>
                        </div>

                        <div class="col-sm-6">
                            <h5>Nota Metacritic</h5><hr>
                            <div class="container ">
                                <div class="row justify-content-center">
                                    <div class="col-lg-3 col-md-6 col-sm-3 ">
                                        ...
                                        elseif ($nota < 75 and $nota >= 50){
                                            echo "boxmed";
                                        }elseif($nota < 50 and $nota > 0){
                                            echo "boxbad";
                                        }else{
                                            echo "box";
                                        }
